...
<https://github.com/reblocke/critical-effect-size/security/advisories/new>
...
- the affected focused contract, browser stage, static interface, workflow, or release path;
...
- A suspected app-orchestration or presentation discrepancy belongs in this repository.
- A suspected numerical primitive belongs to the
  [`wald-inference-core`](https://github.com/reblocke/wald-inference-core) correction process,
  because released Core is the numerical authority.
- A routine, nonsensitive repository bug may use the public engineering issue form.
- Requests for clinical interpretation are out of scope. Publication does not establish clinical
  decision support or regulatory readiness.
